# Fase 01: Modelo e domínio [x]
Branch: `feat/008-modelo`

A base primeiro. Enquanto esta fase não fecha, nenhuma tela tem o que exibir.

- [x] Task 01: Renomear os conceitos no modelo. Arquivo: `src/app/models/community.model.ts`.
  ...
  primeiro a mudar.
- [x] Task 02: Ampliar o `TrackIconId`. Arquivo: `src/app/models/community.model.ts`. Objetivo:
...
- [x] Task 03: Criar o tipo da Elite Four. Arquivo: `src/app/models/community.model.ts`. Objetivo: as
...
- [x] Task 04: Mapear `grade` para nome. Arquivo novo:
...
- [x] Task 05 (TDD): Testar o mapa de progresso. Arquivo: `src/app/core/progress/progress.spec.ts`.
...
# Fase 02: Conteúdo da trilha [x]
Branch: `feat/008-trilha`

O dado antes das telas. É a fase com mais texto e menos código.

- [x] Task 01: Reescrever a identidade. Arquivo: `src/app/services/community.service.ts`. Objetivo:
...
- [x] Task 02: Substituir os 33 Graus pelas 8 Insígnias. Arquivo:
...
- [x] Task 03: Remontar as etapas da trilha. Arquivo: `src/app/services/community.service.ts`.
...
- [x] Task 04: Reescrever as faixas como três tiers. Arquivos:
...
- [x] Task 04b: Tornar a escassez do Ultra visível na tabela. Arquivos:
...
- [x] Task 05: Renomear o Conclave para Grinding Arena. Arquivos:
  ...
  endgame (decisão 1).
- [x] Task 05b: Ligar a Grinding Arena ao Ultra Dev Tier. Arquivos:
...
- [x] Task 06: Atualizar os testes do serviço. Arquivo:
...
- [x] Task 01: Trocar o selo de progresso. Arquivos: `src/app/components/grade-badge/` renomeado para
...
- [x] Task 02: Trocar a régua de progressão. Arquivos: `src/app/components/grade-ladder/` renomeado
...
- [x] Task 03: Ajustar a timeline da trilha. Arquivo:
...
- [x] Task 04: Criar os quatro ícones que faltam. Arquivos:
...
- [x] Task 05: Atualizar os testes de componente. Arquivos: `badge-count.spec.ts`,
...
# Fase 04: Páginas e vocabulário [x]
Branch: `feat/008-paginas`

A varredura. É onde o rebranding aparece para quem usa.

- [x] Task 01: Página da comunidade. Arquivos: `src/app/pages/comunidade/comunidade.page.html`,
...
- [x] Task 02: Landing. Arquivos: `src/app/pages/landing/landing.page.html`, `.ts`, `.scss`.
...
- [x] Task 03: Dashboard. Arquivos: `src/app/pages/dashboard/dashboard-shell.ts`,
  ...
  Fase 03.
- [] Task 03b (adiada, sem cobrança): Preparar o painel para o teto de avanço. Arquivos:
...
- [] Task 03c (adiada, sem cobrança): Deixar o teto de avanço no mesmo lugar do mapa de progresso. Arquivo:
...
- [x] Task 04: Diálogos de auth e waitlist. Arquivos:
...
- [x] Task 01: Ampliar a faixa de `grade`. Arquivo:
  ...
  `12` é campeão.
- [x] Task 02: Nascer sem insígnia. Arquivo: `src/auth/auth.service.ts`. Objetivo: o `grade: 1` do
  `createProfileFor` vira `grade: 0`. Nascer com uma insígnia seria dar uma conquista de graça.
- [x] Task 03: Atualizar os testes que fixam o padrão. Arquivos:
...
- [x] Task 04: Corrigir a documentação da faixa. Arquivos: `README.md`, `CLAUDE.md`,
...
# Fase 06: Documentação [x]
Branch: `feat/008-docs`

- [x] Task 01: Marcar a spec 003 como Deprecated. Arquivo: `specs/003 - Comunidade/context.md`.
  Objetivo: ela definiu a Seita Dev, os 33 Graus, as faixas e o Conclave. Referenciar esta spec, sem
  reescrever o conteúdo dela.
- [x] Task 02: Registrar o vocabulário. Arquivo: `specs/008 - Liga Dev/context.md`, seção nova
